...
async def print_sender_avatar(info, message):
    await message.channel.send(info['item']['modules']['module_author']['avatar']['fallback_layers']['layers'][0]['resource']['res_image']['image_src']['remote']['url'])   #['layers'][0]['resource']['res_image']['image_src']['remote']['url']
