...
async def print_sender_avatar(info, message):
    #await message.channel.send(info['item']['modules']['module_author']['avatar'][''fall])   #['layers'][0]['resource']['res_image']['image_src']['remote']['url']
    print(info['item']['modules']['module_author']['avatar'])
