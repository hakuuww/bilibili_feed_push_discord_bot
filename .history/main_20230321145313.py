...
async def get_dynamic_link(dynamic_id: str) -> str:
    return f"https://t.bilibili.com/775546934951673865{dynamic_id}"
...
async def print_sender_avatar(info, message):
    await message.channel.send(info['item']['modules']['module_author']['avatar']['fallback_layers']['resource']['image_src']['remote']['url'])
    print(info['item']['modules']['module_author']['avatar']['fallback_layers']['resource']['image_src']['remote']['url'])
