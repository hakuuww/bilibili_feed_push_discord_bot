...
async def print_img_link_in_dict(info,message):
    ...
    try:
        ...
        if module_dynamic is not None:
            ...
            if major is not None:
                ...
                if archive is not None:
                    ...
                    await message.channel.send(get_BV_link(BV_id))
        ...
        print(Exception)
        pass
sync(print_img_link_in_dict(info,message))   
...
async def on_message(message):
  ...
  if message.content.startswith('hello'):
    ...
    for dynamic_obj in dynamic_page_info:
        ...
        print_text_in_dict(info,message)
        print_img_link_in_dict(info,message)
        #print(info)
