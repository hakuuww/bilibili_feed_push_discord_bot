...
async def main():
    ...
    for dynamic_obj in dynamic_page_info:
        print("Dynamic type:", d.get_dynamic_type())
        print("Contents:", d.get_contents())
        print("Pics:", d.get_pics())
print("Attach card:", d.get_attach_card())
print("Topic:", d.get_topic())
print("Options:", d.get_options())
